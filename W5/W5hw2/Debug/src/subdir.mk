...
clean-src:
	-$(RM) ./src/DigitalIoPin.d ./src/DigitalIoPin.o ./src/Imutex.d ./src/Imutex.o ./src/LiquidCrystal.d ./src/LiquidCrystal.o ./src/RealTimeClock.d ./src/RealTimeClock.o ./src/W5hw2.d ./src/W5hw2.o ./src/cr_cpp_config.d ./src/cr_cpp_config.o ./src/cr_startup_lpc15xx.d ./src/cr_startup_lpc15xx.o ./src/crp.d ./src/crp.o ./src/sysinit.d ./src/sysinit.o
